...
var Form = React.createClass({
  componentDidMount: function() {
    ...
    var form = new Awesomplete(input, {
      ...
      autoFirst: true,
      list: [
        "Stuart Norton","Rahul Christoffersen","Golda Greenspoon","Stephen Warner","Hannah Brennen","Zahavah Kay","Jamil Fiorino-Habib","Nina Christianson","Olivia Klasios","Nicole Gumapac","Artimes Ghahremani","Taylor Cenac","Shailee Koranne","Saambavi Mano"
      ],
    });
